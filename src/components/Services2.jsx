...
const buttonVariants = {
  ...
  return (
    <section className="py-20 overflow-hidden bg-gradient-to-b from-slate-600 to-gray-800" ref={containerRef}>
...
function AnimatedTitle({ scrollYProgress }) {
    const animationStart = 0.1 // Adjusted to start earlier
    const animationEnd = 0.3
    // Removing the fade-out portion by excluding animationOutStart and animationOutEnd
  ...
  function ServiceBlock({ service, index, onClick, scrollYProgress }) {
    ...
    return (
      <motion.div
        ...
        onClick={onClick}
      >
        <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br bg-gradient-to-r from-orange-500 to-sky-500 rounded-full mb-4 mx-auto">
          ...
          <div className="p-8">
            <div className="flex justify-between items-center mb-4">
              <motion.h3
                ...
                className="text-3xl font-bold text-center mb-4 bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-sky-500"
              >
                {service.title}
              </motion.h3>
              <motion.button
